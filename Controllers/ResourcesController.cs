...
namespace ResourceBookingSystem.Controllers
{
    public class ResourcesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string search)
        {
            ...
            {
                resources = resources.Where(r => r.Name.Contains(search) || r.Location.Contains(search));
            }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Retrieve all upcoming bookings for this resource (where the booking has not yet ended)
            var now = DateTime.Now;
            var bookings = await _context.Bookings
                .Where(b => b.ResourceId == resource.Id && b.EndTime >= now)
                .OrderBy(b => b.StartTime)
                .ToListAsync();
            // Pass bookings to the view using ViewData
        ...
        {
            // ModelState.IsValid checks data annotations for required fields and constraints
